...
[10x-devs](../../../../modules.md) / [prisma](../../../README.md) / [Prisma](../README.md) / InputJsonArray

# Interface: InputJsonArray

Defined in: prisma-main/types/runtime/library.d.ts:1849
...
> **at**(`index`): [`InputJsonValue`](../type-aliases/InputJsonValue.md) \| `null` \| `undefined`
...
> **findLast**(`predicate`, `thisArg?`): [`InputJsonValue`](../type-aliases/InputJsonValue.md) \| `null` \| `undefined`
...
> **toReversed**(): ([`InputJsonValue`](../type-aliases/InputJsonValue.md) \| `null`)[]
...
> **toSorted**(`compareFn?`): ([`InputJsonValue`](../type-aliases/InputJsonValue.md) \| `null`)[]
...
> **toSpliced**(`start`, `deleteCount`, ...`items`): ([`InputJsonValue`](../type-aliases/InputJsonValue.md) \| `null`)[]
...
> **toSpliced**(`start`, `deleteCount?`): ([`InputJsonValue`](../type-aliases/InputJsonValue.md) \| `null`)[]
...
> **with**(`index`, `value`): ([`InputJsonValue`](../type-aliases/InputJsonValue.md) \| `null`)[]
