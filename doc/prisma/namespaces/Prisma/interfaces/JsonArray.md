...
[10x-devs](../../../../modules.md) / [prisma](../../../README.md) / [Prisma](../README.md) / JsonArray

# Interface: JsonArray

Defined in: prisma-main/types/runtime/library.d.ts:2017
...
> **findLast**(`predicate`, `thisArg?`): [`JsonValue`](../type-aliases/JsonValue.md) \| `undefined`
...
> **toReversed**(): [`JsonValue`](../type-aliases/JsonValue.md)[]
...
> **toSorted**(`compareFn?`): [`JsonValue`](../type-aliases/JsonValue.md)[]
...
> **toSpliced**(`start`, `deleteCount`, ...`items`): [`JsonValue`](../type-aliases/JsonValue.md)[]
...
> **toSpliced**(`start`, `deleteCount?`): [`JsonValue`](../type-aliases/JsonValue.md)[]
...
> **with**(`index`, `value`): [`JsonValue`](../type-aliases/JsonValue.md)[]
